...
try {
    ...
    if (!in_array($file['type'], $allowedTypes)) {
        throw new Exception('Tipo de archivo no permitido. Solo se aceptan documentos Word (.doc o .docx)');
    }
    ...
    $outputPath = $outputDir . $uniqueName . '.pdf';
    ...
    $response['fileName'] = $originalName . '.pdf';

    // En un entorno real con LibreOffice instalado, aquí iría el código de conversión
    // $command = "libreoffice --headless --convert-to pdf --outdir $outputDir $uploadPath 2>&1";
